    ...
    return (
        <div className="dyslexia-container">
            ...
            <div className="consent-section">
                <h4 style={{color: "#000000", marginLeft: "10px"}}>For the Test...</h4>
                <label>
                    ...
                    />
                    I consent to the collection and use of my <strong>&nbsp;voice recordings&nbsp;</strong> for research purposes.&nbsp;  
                    <a href="https://www.ftc.gov/business-guidance/privacy-security" 
                       target="_blank" rel="noopener noreferrer" className="learn-more">
                        Learn More
                    </a>
                </label>
                ...
                <label>
                    ...
                    />
                    I consent to the collection and use of my <strong>&nbsp;face recordings&nbsp;</strong> for research purposes.&nbsp;  
                    <a href="https://www.ftc.gov/business-guidance/privacy-security" 
                       target="_blank" rel="noopener noreferrer" className="learn-more">
                        Learn More
                    </a>
